 ...
 *
 * <p>Event type: {@code platform:control-plane:application:activated}
 */
@Builder
public record ApplicationActivated(
    ...
    private static final String EVENT_TYPE = "platform:control-plane:application:activated";
     ...
     */
    public static ApplicationActivatedBuilder fromContext(ExecutionContext ctx) {
        return ApplicationActivated.builder()
