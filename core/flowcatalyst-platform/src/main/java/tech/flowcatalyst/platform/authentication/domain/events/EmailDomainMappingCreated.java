 ...
 *
 * <p>Event type: {@code platform:iam:email-domain-mapping:created}
 */
@Builder
public record EmailDomainMappingCreated(
    String eventId,
    Instant time,
    String executionId,
    ...
    private static final String EVENT_TYPE = "platform:iam:email-domain-mapping:created";
     ...
     */
    public static EmailDomainMappingCreatedBuilder fromContext(ExecutionContext ctx) {
        return EmailDomainMappingCreated.builder()
