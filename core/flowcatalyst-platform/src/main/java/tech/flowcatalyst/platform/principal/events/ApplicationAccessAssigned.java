 ...
 *
 * <p>This is a batch event that captures the complete set of accessible applications
 * after assignment, along with what was added and removed.
 *
 * <p>Event type: {@code platform:iam:user:application-access-assigned}
 */
@Builder
public record ApplicationAccessAssigned(
    String eventId,
    Instant time,
    String executionId,
    ...
    public String toDataJson() {
        try {
            return MAPPER.writeValueAsString(new Data(userId, applicationIds, added, removed));
     ...
     */
    public static ApplicationAccessAssignedBuilder fromContext(ExecutionContext ctx) {
        return ApplicationAccessAssigned.builder()
