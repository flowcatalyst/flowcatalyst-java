 ...
 *
 * <p>Event type: {@code platform:iam:user:updated}
 */
@Builder
public record UserUpdated(
    ...
    public String toDataJson() {
        try {
            return MAPPER.writeValueAsString(new Data(userId, name, clientId));
     ...
     */
    public static UserUpdatedBuilder fromContext(ExecutionContext ctx) {
