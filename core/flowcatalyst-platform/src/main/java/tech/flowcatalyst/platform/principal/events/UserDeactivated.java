 ...
 *
 * <p>Event type: {@code platform:iam:user:deactivated}
 */
@Builder
public record UserDeactivated(
    ...
    private static final String EVENT_TYPE = "platform:iam:user:deactivated";
    ...
    public String toDataJson() {
        try {
            return MAPPER.writeValueAsString(new Data(userId, email, reason));
     ...
     */
    public static UserDeactivatedBuilder fromContext(ExecutionContext ctx) {
        return UserDeactivated.builder()
