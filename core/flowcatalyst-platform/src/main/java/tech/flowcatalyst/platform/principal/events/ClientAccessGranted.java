...
/**
 * Event emitted when a user is granted access to a client.
 *
...
public record ClientAccessGranted(
    ...
    private static final String EVENT_TYPE = "platform:iam:user:client-access-granted";
    ...
    public String toDataJson() {
        try {
            return MAPPER.writeValueAsString(new Data(userId, clientId, grantId, expiresAt));
